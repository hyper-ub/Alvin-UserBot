...
async def nekobot(e):
    ...
    if "|" in input_str:
        ...
        await e.edit(
            "replt toimage or sticker and type `.trap (name user)|(trap name)`"
        )
        return
...
CMD_HELP.update({
    "memeimage":
    ";fgs\
\nUsage: get meme from google!\
\n;fgs [upper text] ; [lower text]\
\n\n<;modi /\ ;trump /\ ;cmm /\ ;kanna> <text>\
\nUsage: Just for Fun.\
\n\n<;ph /\ ;threat /\ ;tras` /\ ;trap >\
\nUsage:reply to sticker or image."
})
