...
async def mim(event):
    ...
    if not event.reply_to_msg_id:
        await event.edit(
            "please reply to image and type ;mmf = upper text ; =lower text, example: (reply)`;mmf hello ; im alvin`"
        )
        return
    reply_message = await event.get_reply_message()
    if not reply_message.media:
        await event.edit("*please reply to image/Sticker/Gif*")
        return
    reply_message.sender
    await bot.download_file(reply_message.media)
    if reply_message.sender.bot:
        await event.edit("*Reply to the actual user's message.*")
        return
    else:
        await event.edit(
            "_wait master, i'll changing this image...._"
        )
...
async def mim(event):
    ...
    if not event.reply_to_msg_id:
        await event.edit(
            "please reply to image and type ;mmf2 = upper text ; =lower text, example: (reply)`;mmf2 hello ; im alvin`"
        )
        return
    reply_message = await event.get_reply_message()
    if not reply_message.media:
...
CMD_HELP.update({
    "memify":
        ";mmf = upper text ; =lower text\
        \nUsage: reply to Sticker/image/Gif.\n"
        ";mmf2 = upper text ; =lower text\
        \nUsage: reply to Sticker/image/Gif."
})
