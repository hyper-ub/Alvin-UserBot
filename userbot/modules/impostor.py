...
async def bruh(message, user):
    ...
    name = "***" + name
    await message.edit(name + choice([" ", " no "]) + "Is A Liar! ***")


CMD_HELP.update(
    {
        "impostor": ";imp\
    \nUsage: Submit a picture of an Among US impostor with your own words.\
    \n\nnotes:red: 1, lime: 2, green: 3, blue: 4, cyan: 5, brown: 6, \npurple: 7, pink: 8, orange: 9, yellow: 10, white: 11, black: 12, "
    }
)
